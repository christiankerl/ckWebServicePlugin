...
/**
 * Base class that represents a row from the 'propel_comment' table.
 *
 * 
 *
...
abstract class BasePropelComment extends BaseObject  implements Persistent {
  ...
  const PEER = 'PropelCommentPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PropelCommentPeer
	 */
	...
	/**
	 * Initializes internal state of BasePropelComment object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PropelComment The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = PropelCommentPeer::NUM_COLUMNS - PropelCommentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PropelCommentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			PropelCommentPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PropelComment (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PropelComment Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getPropelArticle(PropelPDO $con = null)
	{
		if ($this->aPropelArticle === null && ($this->article_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPropelArticle->addPropelComments($this);
			 */
		}
