...
/**
 * Base class that represents a row from the 'propel_article_author' table.
 *
 * 
 *
...
abstract class BasePropelArticleAuthor extends BaseObject  implements Persistent {
  ...
  const PEER = 'PropelArticleAuthorPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PropelArticleAuthorPeer
	 */
	...
	/**
	 * Initializes internal state of BasePropelArticleAuthor object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PropelArticleAuthor The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = PropelArticleAuthorPeer::NUM_COLUMNS - PropelArticleAuthorPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aPropelArticle !== null && $this->article_id !== $this->aPropelArticle->getId()) {
			$this->aPropelArticle = null;
		}
		if ($this->aPropelAuthor !== null && $this->author_id !== $this->aPropelAuthor->getId()) {
			$this->aPropelAuthor = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PropelArticleAuthorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			PropelArticleAuthorPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aPropelArticle !== null) {
				if ($this->aPropelArticle->isModified() || $this->aPropelArticle->isNew()) {
			...
			if ($this->aPropelAuthor !== null) {
				if ($this->aPropelAuthor->isModified() || $this->aPropelAuthor->isNew()) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PropelArticleAuthor (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PropelArticleAuthor Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PropelArticleAuthorPeer
	 */
	...
	/**
	 * Declares an association between this object and a PropelArticle object.
	 *
	 * @param      PropelArticle $v
	 * @return     PropelArticleAuthor The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setPropelArticle(PropelArticle $v = null)
	{
		if ($v === null) {
		...
		// If this object has already been added to the PropelArticle object, it will not be re-added.
		if ($v !== null) {
			$v->addPropelArticleAuthor($this);
		}
	...
	/**
	 * Get the associated PropelArticle object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     PropelArticle The associated PropelArticle object.
	 * @throws     PropelException
	 */
	public function getPropelArticle(PropelPDO $con = null)
	{
		if ($this->aPropelArticle === null && ($this->article_id !== null)) {
			$c = new Criteria(PropelArticlePeer::DATABASE_NAME);
			$c->add(PropelArticlePeer::ID, $this->article_id);
			$this->aPropelArticle = PropelArticlePeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPropelArticle->addPropelArticleAuthors($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a PropelAuthor object.
	 *
	 * @param      PropelAuthor $v
	 * @return     PropelArticleAuthor The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setPropelAuthor(PropelAuthor $v = null)
	{
		if ($v === null) {
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the PropelAuthor object, it will not be re-added.
		if ($v !== null) {
			$v->addPropelArticleAuthor($this);
		}
	...
	/**
	 * Get the associated PropelAuthor object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     PropelAuthor The associated PropelAuthor object.
	 * @throws     PropelException
	 */
	public function getPropelAuthor(PropelPDO $con = null)
	{
		if ($this->aPropelAuthor === null && ($this->author_id !== null)) {
			$c = new Criteria(PropelAuthorPeer::DATABASE_NAME);
			$c->add(PropelAuthorPeer::ID, $this->author_id);
			$this->aPropelAuthor = PropelAuthorPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPropelAuthor->addPropelArticleAuthors($this);
			 */
		}
